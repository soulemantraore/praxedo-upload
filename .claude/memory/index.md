...
- [decisions-archi](decisions-archi.md) — Journal des décisions d'architecture (ADR light) prises pendant le brainstorming.
...
- [infra](infra.md) — Outillage déploiement GCP (non exécuté) : topologie Cloud Run **3 services** api + worker(léger) + **scanner** (Python+ClamAV, D15), Makefile gcloud, IAM moindre privilège, décision sidecar Cloud SQL Auth Proxy.
